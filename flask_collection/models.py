...
class Book(db.Model):
    ...
    org_title = db.Column(db.String(50))
    org_sub_title = db.Column(db.String(50))
    volume = db.Column(db.Integer)
    publication_date = db.Column(db.DateTime)
    org_publication_year = db.Column(db.String(4))
    print_format = db.Column(db.String(20))
    pages = db.Column(db.Integer)
    publisher = db.Column(db.String(20))
    cover = db.Column(db.String(20), default='placeholder.png')
